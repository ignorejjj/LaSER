...
class ModelArguments:
    ...
    num_thinking_steps: int = field(
        default=3,
        metadata={"help": "number of thinking steps"}
    )
...
class DataArguments:
    ...
    append_think_token: bool = field(
        default=False, metadata={"help": "append think token to query and passage"}
    )

    add_chat_template: bool = field(
        default=False, metadata={"help": "add chat template to query and passage"}
    )
